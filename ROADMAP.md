...
- [ ] Remaining: component contents/slots + events, component-instance salvage across skeleton rebuilds, LIS reconciler, deep-reactive opt-in, engine flag + spec-parity gate
