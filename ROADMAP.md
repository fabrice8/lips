...
- [ ] Remaining parity gaps (old-engine suites still cover them): router, i18n, macros, component contents/slots + events, dynamic template objects, component-instance salvage across skeleton rebuilds, LIS reconciler
